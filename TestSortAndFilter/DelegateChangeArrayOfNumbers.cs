...
{
    /// <summary>
    /// Test in general method for change array using delegate
    /// </summary>
    [TestFixture]
    public class DelegateChangeArrayOfNumbers
    {
        /// <summary>
        /// Test with valid data for the method ChangeArrayElements using delegate
        /// </summary>
        [Test]
        ...
        /// </summary>
        [Test]
        public void NUnitTest_Delegate_ChangeArrayElements_If_Input_Number_Less_Then_0()
        {
            var powValue = -1;
